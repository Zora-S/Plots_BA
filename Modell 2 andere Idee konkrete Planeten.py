...
R_stern = 0.3 *6.96342*10**8 # *6.96342*10**8 weil sonnenradius
T_stern = 3269 # in Kelvin
M_stern = 0.28 *1.989*10**30 # *1.989*10**30 weil sonnenmasse
R_planet = 6 * 673e4 -4000
M_planet = 16.5 * 5.9722e27 #5513*4/3*math.pi*R_planet**3 #Masse des Planeten ausgerechnet über die dichte, erddichte als referenzwert 
A_B = 0.9 #0.1 bis 0.9
e = 0.32 #0.1 bis 0.9
